...
public class ModItemGroups
{
    ...
    public static final ItemGroup ASHELF_TAB = FabricItemGroupBuilder.build(new Identifier(AestheticShelving.MOD_ID, "ashelftab"),
            () -> new ItemStack(ModBlocks.SHELVES.get("oak")));
