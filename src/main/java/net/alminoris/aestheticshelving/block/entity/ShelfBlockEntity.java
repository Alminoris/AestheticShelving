...
import net.alminoris.aestheticshelving.screen.ShelfScreenHandler;
...
public class ShelfBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPosPayload>, ImplementedInventory
{
    ...
    {
        return new ShelfScreenHandler(syncId, playerInventory, this);
    }
