...
import net.alminoris.aestheticshelving.screen.TowerShelfScreenHandler;
...
public class TowerShelfBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory
{
    ...
    {
        return new TowerShelfScreenHandler(syncId, playerInventory, this);
    }
