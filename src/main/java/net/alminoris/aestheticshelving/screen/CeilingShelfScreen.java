...
public class CeilingShelfScreen extends HandledScreen<CeilingShelfScreenHandler>
{
    ...
    protected void drawForeground(MatrixStack matrices, int mouseX, int mouseY)
    {
        textRenderer.draw(matrices, this.title.asOrderedText(), this.titleX,
                this.titleY, WOOD_COLORS.get(getWoodName(ModBlocks.CEILING_SHELVES, handler.blockEntity)));
        textRenderer.draw(matrices, this.playerInventoryTitle.asOrderedText(),
                this.playerInventoryTitleX, this.playerInventoryTitleY, WOOD_COLORS.get(getWoodName(ModBlocks.CEILING_SHELVES, handler.blockEntity)));
    }
