...
public class TowerShelfScreen extends HandledScreen<TowerShelfScreenHandler>
{
    private final Identifier TEXTURE = Identifier.of(AestheticShelving.MOD_ID,
            "textures/gui/"+ getWoodName(ModBlocks.TOWER_SHELVES, handler.blockEntity) +"_standing.png");;
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY)
    {
        context.drawText(this.textRenderer, this.title, this.titleX, this.titleY,
                WOOD_COLORS.get(getWoodName(ModBlocks.TOWER_SHELVES, handler.blockEntity)), false);
        context.drawText(this.textRenderer, this.playerInventoryTitle, this.playerInventoryTitleX, this.playerInventoryTitleY,
                WOOD_COLORS.get(getWoodName(ModBlocks.TOWER_SHELVES, handler.blockEntity)), false);
    }
