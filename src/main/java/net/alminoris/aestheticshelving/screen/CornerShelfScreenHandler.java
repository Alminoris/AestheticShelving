...
public class CornerShelfScreenHandler extends ScreenHandler
{
    ...
    //Client
    public CornerShelfScreenHandler(int syncId, PlayerInventory inventory, BlockPosPayload payload)
    {
        this(syncId, inventory, (CornerShelfBlockEntity) inventory.player.getWorld().getBlockEntity(payload.pos()));
    }
