...
import static net.alminoris.aestheticshelving.util.helper.BlockSetsHelper.*;
...
public class ShelfScreen extends HandledScreen<ShelfScreenHandler>
{
    ...
    protected void drawForeground(MatrixStack matrices, int mouseX, int mouseY)
    {
        textRenderer.draw(matrices, this.title.asOrderedText(), this.titleX,
                this.titleY, WOOD_COLORS.get(getWoodName(ModBlocks.SHELVES, handler.blockEntity)));
        textRenderer.draw(matrices, this.playerInventoryTitle.asOrderedText(),
                this.playerInventoryTitleX, this.playerInventoryTitleY, WOOD_COLORS.get(getWoodName(ModBlocks.SHELVES, handler.blockEntity)));
    }
