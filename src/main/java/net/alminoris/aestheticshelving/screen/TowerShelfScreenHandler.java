...
public class TowerShelfScreenHandler extends ScreenHandler
{
    ...
    //Client
    public TowerShelfScreenHandler(int syncId, PlayerInventory inventory, BlockPosPayload payload)
    {
        this(syncId, inventory, (TowerShelfBlockEntity) inventory.player.getWorld().getBlockEntity(payload.pos()));
    }
